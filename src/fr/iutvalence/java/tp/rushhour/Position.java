...
public class Position {
     ...
     *
     * @param noRow    the number of row
     * @param noColumn the number of column
     */
    ...
    /**
     * Build a new position, from a given row+row delta/column + column delta intersection.
     * 
	 * @param noRow the number of row
     * @param noRowDelta the number of row delta
	 * @param noColumn the number of column
     * @param noColumnDelta  the number of column delta
	 */
