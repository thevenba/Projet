...
public class Level2 extends Board
{
	...
	protected List<Vehicle> createVehicle()
	{
        ...
        vehicles.add(new Vehicle(Vehicle.VERTICAL, 2, Color.LIGHT_BLUE, new Position(4, 4)));
        vehicles.add(new Vehicle(Vehicle.VERTICAL, 2, Color.ORANGE, new Position(2, 3)));
        vehicles.add(new Vehicle(Vehicle.HORIZONTAL, 3, Color.YELLOW, new Position(0, 5)));
        ...
        vehicles.add(new Vehicle(Vehicle.HORIZONTAL, 2, Color.PURPLE, new Position(3, 4)));
