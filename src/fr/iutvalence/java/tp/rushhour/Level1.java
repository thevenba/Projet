...
public class Level1 extends Board
{
	...
	protected List<Vehicle> createVehicle()
	{
		...
		vehicles.add(new Vehicle(Vehicle.VERTICAL, 3, Color.YELLOW, new Position(2, 5)));
		...
		vehicles.add(new Vehicle(Vehicle.HORIZONTAL, 3, Color.DARK_GREEN, new Position(5, 4)));
		vehicles.add(new Vehicle(Vehicle.VERTICAL, 3, Color.PURPLE, new Position(3, 0)));
		return vehicles;
	}
}
